...
namespace ecn_baxter::setup
{
    ...
    void SetupPointsClient::ptn_setup_goal(const PtnSetupHandler::SharedPtr &handle)
    {
        if (!handle)
        {
    ...
    void SetupPointsClient::ptn_setup_result(const PtnSetupHandler::WrappedResult &result)
    {
        switch (result.code)
        {
    ...
    void SetupPointsClient::ptn_setup_feedback(PtnSetupHandler::SharedPtr &handle,
